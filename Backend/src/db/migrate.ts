...
export const BOOTSTRAP_MIGRATIONS: BootstrapMigration[] = [
  ...
  {
    /*
     * 045_supplier_invoice_line_financial_truth
     *
     * Supplier Invoice Financial Truth & Cost Normalisation — Operational Suite
     *
     ...
     */
    id: "045_supplier_invoice_line_financial_truth",
    sql: `
      ALTER TABLE supplier_invoice_lines
