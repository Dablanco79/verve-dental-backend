...
// Fixed catalog item UUID from the seed data (created by seedInventory)
// Matches SEED_SKU_IDS in inventoryRepository.ts
const SEED_GLOVES_ITEM_ID = "aaaaaaaa-cccc-4ccc-8ccc-cccccccccc01";
